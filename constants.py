...
PLATE_TYPES = {
    ...
    "government_local": {
        "name": "Xe cơ quan nhà nước (Địa phương)",
        "description": "Biển xanh dương, chữ trắng",
    },
    "government_central": {
        "name": "Xe cơ quan nhà nước (Trung ương)",
        "description": "Biển xanh dương (mã 80), chữ trắng",
    },
    "military": {"name": "Xe quân đội", "description": "Biển đỏ, chữ trắng"},
    "police": {"name": "Xe công an", "description": "Biển xanh dương, chữ trắng"},
    "diplomatic_ng": {
        "name": "Xe ngoại giao (NG)",
        "description": "Biển trắng, chữ đen, ký hiệu NG",
    },
    "diplomatic_qt": {
        "name": "Xe ngoại giao (QT)",
        "description": "Biển trắng, chữ đen, ký hiệu QT",
    },
    "foreign_nn": {
        "name": "Xe nước ngoài (NN)",
        "description": "Biển trắng, chữ đen, ký hiệu NN",
    },
    "temporary": {
        "name": "Biển tạm",
        "description": "Thường có chữ T",
    },
    "motorcycle": {
        "name": "Xe máy",
